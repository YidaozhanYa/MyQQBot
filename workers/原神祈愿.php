...
define("GACHA_ID",array(
	...
	"126"=> "华紫樱绯/0216-0308 (八重神子, 菲谢尔, 迪奥娜, 托马)",
	"127"=> "影寂天下人/0308-0329 (雷电将军, 班尼特, 辛焱, 九条裟罗)",
	"128"=> "苍流踏花/0330-0419 (神里绫人, 云堇, 砂糖, 香菱)",
	"21"=>"浪涌之瞬 复刻/1124-1214 (优菈, 罗莎莉亚, 诺艾尔, 班尼特)",
	"22"=>"烟火之邀 复刻/0105-0125 (魈, 云堇, 凝光, 重云)",
	"23"=>"浮生孰来 复刻/0125- (甘雨, 烟绯, 行秋, 北斗)",
	"24"=> "浮岳虹珠/0308-0329 (珊瑚宫心海, 班尼特, 辛焱, 九条裟罗)",
	"25"=> "杯装之诗/0330-0419 (温迪, 云堇, 砂糖, 香菱)",
	...
	"325"=> "0216-0308 (神乐之真意, 磐岩结绿, 断浪长鳍, 绝弦, 祭礼剑, 昭心, 雨裁)",
	"326"=> "0308-0329 (薙草之稻光, 不灭月华, 恶玉丸, 曚云之月, 匣里龙吟, 西风长枪, 祭礼残章)",
	"327"=> "0330-0419 (波乱月白经津, 终末嗟叹之诗, 弓藏, 笛剑, 流浪乐章, 匣里灭辰, 祭礼大剑)",
...
function msg_handler($args)
{
	...
	if ($args['command'] == "帮助") {
		send_msg($args,'[CQ:image,file=file://'.getcwd().'/images/原神祈愿help1.png]');
		send_msg($args,'[CQ:image,file=file://'.getcwd().'/images/原神祈愿help2.png]');
		return;
	} else {
		// 正式
		...
		$gacha = file_get_contents(getcwd() . "/output.txt");
			...
			send_msg_topicture($args,$gacha,"ys");
		return;
	};
};
